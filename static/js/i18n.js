...
const TRANSLATIONS = {
  vi: {
    ...
    // PDF Redact
    rd_title: "Ẩn Dữ Liệu Nhạy Cảm",
    rd_desc: "Ẩn và xóa vĩnh viễn thông tin nhạy cảm trong file PDF — không thể khôi phục",
    rd_upload_hint: "Kéo thả file PDF vào đây hoặc click để chọn",
    rd_mode_label: "🎯 Chọn chế độ",
    rd_mode_auto: "Tự động phát hiện",
    rd_mode_auto_desc: "Quét và ẩn tự động email, SĐT, CCCD...",
    rd_mode_keyword: "Theo từ khóa",
    rd_mode_keyword_desc: "Nhập từ khóa cần ẩn",
    rd_mode_both: "Kết hợp",
    rd_mode_both_desc: "Tự động + từ khóa",
    rd_categories: "📋 Loại dữ liệu cần phát hiện",
    rd_cat_phone_vn: "📱 SĐT Việt Nam",
    rd_cat_phone_jp: "📱 SĐT Nhật Bản",
    rd_cat_cccd: "🪪 CMND / CCCD",
    rd_cat_bank: "🏦 Số tài khoản",
    rd_cat_card: "💳 Số thẻ",
    rd_cat_address: "📍 Địa chỉ",
    rd_keyword_label: "🔑 Nhập từ khóa cần ẩn",
    rd_keyword_hint: "Phân cách bằng dấu phẩy (,) — Không phân biệt hoa/thường",
    rd_fill_color: "🎨 Kiểu che",
    rd_color_black: "Hộp đen",
    rd_color_white: "Hộp trắng",
    rd_warning_title: "Cảnh báo:",
    rd_warning_text: "Dữ liệu sau khi ẩn sẽ bị xóa VĨNH VIỄN khỏi file PDF. Không thể khôi phục. Hãy giữ bản gốc nếu cần.",
    rd_btn_scan: "🔍 Quét trước",
    rd_btn_redact: "🔒 Ẩn dữ liệu",
    rd_btn_download: "⬇ Tải xuống",
    rd_processing: "Đang xử lý... Quá trình này có thể mất vài phút.",
    rd_found_items: "mục nhạy cảm được phát hiện",
    rd_page: "Trang",
    rd_success: "✅ Ẩn dữ liệu thành công!",
    rd_result_info: "🔒 {count} mục đã ẩn trên {pages} trang<br>📦 {orig} MB → {new} MB",
    rd_tips_title: "💡 Lưu ý quan trọng",
    rd_tips_content: "• Chức năng này XÓA VĨNH VIỄN dữ liệu khỏi PDF — không thể copy, search hay khôi phục. • Nên \"Quét trước\" để xem dữ liệu sẽ bị ẩn trước khi áp dụng. • Hỗ trợ phát hiện: email, số điện thoại VN/JP, CMND/CCCD, số tài khoản ngân hàng, số thẻ.",

    // About
    about_title: "Giới Thiệu",
    about_tagline: "Bộ công cụ xử lý tài liệu nội bộ — Được phát triển để hỗ trợ nhân viên OVNC giảm tải công việc lặp lại, tăng hiệu suất làm việc mỗi ngày.",
    about_mission_title: "Sứ mệnh",
    about_mission_text: "Giúp nhân viên OVNC tiết kiệm thời gian xử lý các công việc lặp lại hằng ngày như chỉnh sửa PDF, chuyển đổi file, so sánh tài liệu... để tập trung vào những việc quan trọng hơn.",
    about_why_title: "Tại sao OVNC Tools?",
    about_why_text: "Không cần cài đặt phần mềm, không cần tài khoản, không upload dữ liệu lên internet. Mọi thứ xử lý trên server nội bộ — nhanh, an toàn, miễn phí.",
    about_opensource_title: "Mã nguồn mở",
    about_opensource_text: "OVNC Tools được phát triển bằng Python + FastAPI, hoàn toàn mã nguồn mở. Sử dụng miễn phí, không quảng cáo, không theo dõi người dùng.",
    about_nodata_title: "Không lưu trữ dữ liệu",
    about_nodata_text: "Hệ thống KHÔNG sử dụng database. File upload được xử lý tức thì và tự động xóa sau vài giây. Không dữ liệu nào của bạn được lưu trên server.",
    about_features_title: "📦 Tính năng hiện có",
    about_tech_title: "⚙️ Công nghệ sử dụng",
    about_tech_i18n: "Việt 🇻🇳 + Nhật 🇯🇵",
    about_privacy_title: "🛡️ Chính sách bảo mật",
    about_priv_1: "Tất cả dữ liệu được xử lý trên server nội bộ OVNC — không gửi ra internet",
    about_priv_2: "File upload tự động xóa sau khi xử lý xong (trong vòng 10 giây)",
    about_priv_3: "Không sử dụng database — không lưu trữ nội dung file hay thông tin cá nhân",
    about_priv_4: "Không yêu cầu đăng nhập hay tài khoản",
    about_priv_5: "Không quảng cáo, không tracking, không cookies theo dõi",
    about_quote: "\"Công cụ tốt nhất là công cụ giúp bạn hoàn thành công việc nhanh hơn — để dành thời gian cho những điều quan trọng hơn.\"",
  ...
  ja: {
    ...
    // PDF Redact
    rd_title: "機密データ墨消し",
    rd_desc: "PDFファイルの機密情報を永久に隠蔽・削除 — 復元不可",
    rd_upload_hint: "PDFファイルをここにドラッグするか、クリックして選択",
    rd_mode_label: "🎯 モードを選択",
    rd_mode_auto: "自動検出",
    rd_mode_auto_desc: "メール、電話番号、ID番号を自動検出して墨消し",
    rd_mode_keyword: "キーワード指定",
    rd_mode_keyword_desc: "隠したいキーワードを入力",
    rd_mode_both: "組み合わせ",
    rd_mode_both_desc: "自動検出 + キーワード",
    rd_categories: "📋 検出するデータの種類",
    rd_cat_phone_vn: "📱 ベトナム電話番号",
    rd_cat_phone_jp: "📱 日本電話番号",
    rd_cat_cccd: "🪪 身分証明書番号",
    rd_cat_bank: "🏦 口座番号",
    rd_cat_card: "💳 カード番号",
    rd_cat_address: "📍 住所",
    rd_keyword_label: "🔑 隠したいキーワードを入力",
    rd_keyword_hint: "カンマ (,) で区切る — 大文字小文字を区別しない",
    rd_fill_color: "🎨 墨消しスタイル",
    rd_color_black: "黒ボックス",
    rd_color_white: "白ボックス",
    rd_warning_title: "警告:",
    rd_warning_text: "墨消し後のデータはPDFから永久に削除されます。復元できません。必要に応じて原本を保管してください。",
    rd_btn_scan: "🔍 事前スキャン",
    rd_btn_redact: "🔒 墨消し実行",
    rd_btn_download: "⬇ ダウンロード",
    rd_processing: "処理中... 数分かかる場合があります。",
    rd_found_items: "件の機密データを検出",
    rd_page: "ページ",
    rd_success: "✅ 墨消しが完了しました！",
    rd_result_info: "🔒 {count}件を{pages}ページで墨消し<br>📦 {orig} MB → {new} MB",
    rd_tips_title: "💡 重要な注意事項",
    rd_tips_content: "• この機能はPDFからデータを永久に削除します — コピー、検索、復元はできません。 • 適用前に\"事前スキャン\"で確認することをお勧めします。 • 検出対応: メール、電話番号(VN/JP)、身分証明書、銀行口座、カード番号。",

    // About
    about_title: "紹介",
    about_tagline: "社内ドキュメント処理ツール — OVNC社員の日常的な繰り返し作業を削減し、業務効率を向上させるために開発されました。",
    about_mission_title: "ミッション",
    about_mission_text: "OVNC社員がPDF編集、ファイル変換、ドキュメント比較などの日常的な繰り返し作業にかかる時間を節約し、より重要な業務に集中できるようにします。",
    about_why_title: "なぜOVNC Tools？",
    about_why_text: "ソフトウェアのインストール不要、アカウント不要、インターネットへのデータアップロードなし。すべて社内サーバーで処理 — 高速・安全・無料。",
    about_opensource_title: "オープンソース",
    about_opensource_text: "OVNC ToolsはPython + FastAPIで開発された完全なオープンソースツールです。無料で利用可能、広告なし、ユーザー追跡なし。",
    about_nodata_title: "データ保存なし",
    about_nodata_text: "システムはデータベースを使用しません。アップロードされたファイルは即座に処理され、数秒後に自動削除されます。データは一切保存されません。",
    about_features_title: "📦 現在の機能",
    about_tech_title: "⚙️ 使用技術",
    about_tech_i18n: "ベトナム語 🇻🇳 + 日本語 🇯🇵",
    about_privacy_title: "🛡️ プライバシーポリシー",
    about_priv_1: "すべてのデータはOVNC社内サーバーで処理 — インターネットには送信されません",
    about_priv_2: "アップロードファイルは処理後10秒以内に自動削除されます",
    about_priv_3: "データベース不使用 — ファイル内容や個人情報は保存されません",
    about_priv_4: "ログインやアカウントは不要です",
    about_priv_5: "広告なし、トラッキングなし、追跡Cookieなし",
    about_quote: "\"最高のツールとは、仕事をより速く終わらせてくれるツール — もっと大切なことに時間を使うために。\"",
